...
//            })
    ...
    if(renderBlog) {
        ...
        } else if(props.isPreview) {//<ReactMarkdown>{`${previewContent(blog.content)}...`}</ReactMarkdown>
            return (//<ReactMarkdown>{`${blog.content.substring(0, 300)}...`}</ReactMarkdown>
                <div>
                    <h1>{blog.title}</h1>
                    <p>{blog.created_at}</p>
                    ...
                    <ReactMarkdown>{previewContent(blog.content)}</ReactMarkdown>
